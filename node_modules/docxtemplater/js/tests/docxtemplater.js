...
var fileNames = ["angular-example.docx", "cyrillic.docx", "image-example.docx", "table-complex2-example.docx", "table-complex-example.docx", "tag-dash-loop.docx", "tag-dash-loop-list.docx", "tag-dash-loop-table.docx", "tag-example.docx", "tag-example-expected.docx", "tag-intelligent-loop-table.docx", "tag-intelligent-loop-table-expected.docx", "tag-loop-example.docx", "tag-produit-loop.docx", "simple-example.pptx", "loop-example.pptx", "expected-loop-example.pptx", "raw-xml-example.pptx", "one-raw-xml-tag.docx", "image.png"];
...
function startTest() {
	...
	describe("pptx generation", function () {
		...
		it("should work with loop pptx", function () {
			var doc = testUtils.createPpt("loop-example.pptx");
		...
		it("should work with simple raw pptx", function () {
			var doc = testUtils.createPpt("raw-xml-example.pptx");
